...
export default function EventComments({ eventId, currentUserId }: { eventId: string; currentUserId: string }) {
  ...
  async function load() {
    const res = await fetch(`/api/admin/events/${eventId}/comments`);
    if (res.ok) {
