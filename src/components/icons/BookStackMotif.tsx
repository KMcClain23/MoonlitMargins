...
export default function BookStackMotif({
  ...
  return (
    <svg
      ...
      aria-hidden="true"
    >
      <rect x="10" y="150" width="140" height="24" rx="3" fill="#8E86E5" opacity="0.18" />
      <rect x="18" y="122" width="124" height="24" rx="3" fill="#8E86E5" opacity="0.16" />
      <rect x="26" y="94" width="108" height="24" rx="3" fill="#8E86E5" opacity="0.14" />
      <rect x="34" y="66" width="92" height="24" rx="3" fill="#8E86E5" opacity="0.12" />
